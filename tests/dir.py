...
class TestDir:
    ...
    def test_child_check(self):
        ...
        assert dir_node.has_child(dir_node)
    ...
    def test_directory_insertion(self):
        ...
        inserted_amount = dir_node.insert_node(overflow_node)
        assert inserted_amount == None
        assert node.parent == None or node.parent.name != dir_name
